...
<template>
  <div class="container">
    <form align='center'>
      <input type="text" v-model='updGal.name' name='updGal.name' placeholder="Enter Girl Name">
      <input type="file" @change='uploadFile' name='updGal.photo' placeholder="upload file">
